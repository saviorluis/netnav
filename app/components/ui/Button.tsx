...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary-950 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary-600 text-primary-50 shadow hover:bg-primary-600/90",
        destructive:
          "bg-error-600 text-error-50 shadow-sm hover:bg-error-600/90",
        outline:
          "border border-secondary-200 bg-white shadow-sm hover:bg-secondary-100 hover:text-secondary-900",
        secondary:
          "bg-secondary-100 text-secondary-900 shadow-sm hover:bg-secondary-100/80",
